...
async function searchSong() {
    try {
        ...
        const searchUrl = `https://v1.nocodeapi.com/jmusic1/spotify/BAbSnWfxeyCuOtql/search?q=${encodeURIComponent(query)}&type=track`;
...
async function getTrackIdByArtist(artistName) {
  try {
    ...
    const searchUrl = `https://v1.nocodeapi.com/jmusic1/spotify/BAbSnWfxeyCuOtql/search?q=${encodedArtistName}&type=track`;
...
try {
        ...
        const trackInfoUrl = `https://v1.nocodeapi.com/jmusic1/spotify/BAbSnWfxeyCuOtql/tracks?ids=${trackIdsStr}`;
