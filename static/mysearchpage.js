...
async function searchSong() {
    try {
        ...
        const searchUrl = `https://v1.nocodeapi.com/jmusic_1/spotify/tTVlVIfXSBvLAfHl/search?q=${encodeURIComponent(query)}&type=track`;
...
try {
        ...
        const trackInfoUrl = `https://v1.nocodeapi.com/jmusic_1/spotify/tTVlVIfXSBvLAfHl/tracks?ids=${trackIdsStr}`;
